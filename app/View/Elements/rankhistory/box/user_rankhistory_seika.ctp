...
<!-- button -->
		<div class="common-button">
			<?php echo $this->Html->link(__('全件'), array('action' => '/seika'), array('class' => "btn")); ?>
...
<!-- csv download -->
		<?php echo $this->Html->link(__('CSV'), array('controller' => 'rankhistories', 'action' => 'csv_seika_keyword', isset($this->params['pass'][1])?$this->params['pass'][1]:'')); ?>
<!-- table -->
