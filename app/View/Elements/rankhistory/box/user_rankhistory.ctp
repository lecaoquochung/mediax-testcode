...
<!-- description -->
	<div class="description-box">
		...
		<br />
		<span class="label-warning"><i class="icon-remove"></i></span>
...
<!-- button -->
		<div class="common-button">
			<?php echo $this->Html->link(__('全件'), array('action' => '/'), array('class' => "btn")); ?>
...
<!-- csv download -->
		<?php echo $this->Html->link(__('CSV'), array('controller' => 'rankhistories', 'action' => 'csv_all_keyword', isset($this->params['pass'][1])?$this->params['pass'][1]:'')); ?>
<!-- table -->
					...
					<td class="actions">
						...
						<div class="btn-warning" style="float: right;">
							<i class="icon-remove">
								...
								<?php echo $this->Form->postLink('', array('controller' => 'keywords', 'action' => 'nocontract', $rankhistory['Keyword']['ID'],($rankhistory['Keyword']['nocontract']==1?0:1)), array('class' => ''), __('【%s】を未契約しますか？', $rankhistory['Keyword']['ID'])); ?>
							</i>
						</div>
						<?php endif ?>
					</td>
