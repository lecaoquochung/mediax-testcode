<div class="box admin_students_edit span12">
	<div class="navbar">
		...
		<h3 class="brand"><?php  echo __('Edit Jobhunter'); ?></h3>
		</div>
	</div>
	<div class="section">
		<?php App::import('Vendor', 'session_flash_message_box'); echo session_flash_message_box::err($this);?>
		<?php echo $this->Form->create('Jobhunter',array('type'=>'file')); ?>
		<?php
			echo $this->Form->input('Support.label',array('div'=>FALSE,'label'=>__('Support Memo'),'class'=>'input-small','type'=>'select','options'=>Configure::read('SUPPORT_LABEL')));
