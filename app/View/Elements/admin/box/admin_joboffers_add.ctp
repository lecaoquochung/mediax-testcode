<div class="box admin_students_add span12">
	<div class="navbar">
		...
		<h3 class="brand"><?php  echo __('Add Joboffer'); ?></h3>
		</div>
	</div>
	<div class="section">
		<?php 
	...
	<div class="page_navigations">
		<div class="actions">
			...
			<ul><li><?php echo $this->Html->link(__('List Joboffers'), array('action' => 'index')); ?></li></ul>
		</div>
	</div>
</div>
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(':submit').click(function(){
			if($('#JobofferCompanyId').val()==null){
				$.msgbox(
					'<div class=\"popup_top\"><p>エラーメッセージ</p></div><div class=\"pop-cont\"><p>企業を選んでください。</p></div>',
					{type: "confirm",buttons : [
						{type: "cancel", value: "確認"}
					]}
				);
				return false;				
			}else{
				$('#JobofferAddForm').submit();
			}			
		})
	})
</script>