...
<!-- new contract: ranks -->
			<li class="treeview 
				...
				<a href="#">
					<i class="fa fa-jpy"></i><span><?php echo __('Contract'); ?><small class="label bg-green">new</small></span><i class="fa fa-angle-left pull-right"></i>
				</a>
...
<!-- contract old-->
			<li class="treeview 
				...
				<a href="#">
					<i class="fa fa-jpy"></i><span><?php echo __('Contract') ."　（旧）"; ?></span><i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
					<!-- keyword -->
