...
<?php echo $this->Form->create('MRankhistory'); ?>
	<fieldset>
		<legend><?php echo __('Edit M Rankhistory'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MRankhistory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MRankhistory.id'))); ?></li>
