...
//Thay doi kich thuoc cua pop-up  
  $.extend({
      ...
      overlay:{
        ...
        inject:function(){
          ...
          if(ie6){
            ...
            $('html, body').css({'height':'100%','width':'100%','margin-left':0,'margin-right':0})
          }
        },
        ...
        resize:function(x,y){
          ...
          if(this.shim)
            thenvato.comlis.shim.css({'height':0,'width':0});
        ...
        show:function(){
          ...
          this.hidden=false;
          this.transition=this.element.fadeIn(this.options.showDuration,$.proxy(function(){this.element.trigger('show')},this));
          return this
        },
        ...
        hide:function(){
          ...
          this.transition=this.element.fadeOut(this.options.closeDuration,$.proxy(function(){
            ...
            this.element.css({'height':0,'width':0})},this));
        ...
        addevents:function(){
          ...
          $(window).bind('scroll',$.proxy(function(){this.moveBox()},this));
          
          this.esqueleto.msgbox.bind('keydown',$.proxy(function(event){if(event.keyCode==27){this.close(false)}},this));     
          this.esqueleto.form.bind('submit',$.proxy(function(event){event.preventDefault()},this));
        ...
        show:function(txt,options,callback){
          ...
          this.esqueleto.msgbox.queue(this.options.name,$.proxy(function(next){
            options=$.extend(true,{type:'alert'},options||{});
            if(options.buttons===undefined){
              if(options.type=='confirm'||options.type=='prompt'){
                var buttons=[{type:'submit',value:'Accept'},{type:'cancel',value:'Cancel'}]
              }
              else{
                var buttons=[{type:'submit',value:'Accept'}]
              }
            }
            else{
              ...
              $.each(buttons,$.proxy(function(i,button){
                ...
                */
                ...
                if(button.type=='submit'){
                  ...
                  this.esqueleto.buttons.append($('<button type="button">'+button.value+'</button>').bind('click',$.proxy(function(e){this.close(false);e.preventDefault()},this)))}},this))
                }
                else if(options.type=='prompt'){
                  $.each(buttons,$.proxy(function(i,button){
                    /*
                    if(document.domain.indexOf("")!=-1||document.domain.indexOf("inspira.me")!=-1||document.domain.indexOf("localhost")!=-1){                      
                    }
                    else{
                      return false
                    }
                ...
                $.each(types,$.proxy(function(i,e){
                  this.esqueleto.wrapper.removeClass(this.options.name+'-'+e)},this));
        ...
        close:function(param){
          ...
          setTimeout($.proxy(function(){
            this.i--;
            this.esqueleto.msgbox.dequeue(this.options.name)},this),
    ...
    $(function(){
      ...
      if(document.domain.indexOf("envato.com")!=-1||document.domain.indexOf("inspira.me")!=-1||document.domain.indexOf("localhost")!=-1){
        ...
        $.msgbox("<p><strong>jQuery MsgBox</strong> v.1.0 - for jQuery 1.3+</p><p><a href='http://codecanyon.net/user/aeroalquimia/portfolio'>Buy this file in CodeCanyon.net</a></p><p>Copyright 2010, Eduardo Daniel Sada <br/>You need to buy a license if you want use this script. <br/> <a href='http://codecanyon.net/wiki/buying/howto-buying/licensing/'>http://codecanyon.net/wiki/buying/howto-buying/licensing/</a></p>")
      }
      */
    })
  })(jQuery);
