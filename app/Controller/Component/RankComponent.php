    ...
    public function keyWordRank($engine, $url, $keyword, $strict = 0, $g_local=0, $speed = 0, $savecache = false, $onlytop10 = false) {
        ...
        $engines['google_jp'] = array(
         ...
         $engines['yahoo_jp'] = array(
            ...
            'url4' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url5' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url6' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url7' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url8' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url9' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            'url10' => 'http://search.yahoo.co.jp/search?p=_QUERY_&aq=-1&oq=&ei=UTF-8&x=wrt&b=_START_',
            // 'pattern' => '/<li><a href="([^<>]*)">/',
            'pattern' => '/<div class="hd".*?href="([^<>]*)" onmousedown/'
        );

        $start_base = ($engine == 'yahoo_jp' || $engine == 'yahoo_en') ? 1 : 0;
        $page_start++;
        $pagemax = ($engine == 'yahoo_jp' || $engine == 'yahoo_en') ? 9 : 1;
        ...
        for ($page = $page_start; $page <= $pagemax; $page++) {
           ...
           if($engine !== 'yahoo_jp') {
            ...
            $html = ($engine == 'yahoo_jp') ? $this -> getWebContentSpeed($search_url) : $this -> getWebContent($search_url);
 ...
 * @created             2014
 -------------------------------------------------------------------------------------------------------------*/
    public function YahooJP($engine, $url, $keyword, $strict = 0, $g_local=0, $speed = 0, $savecache = false, $onlytop10 = false, $pagemax = 2) {
