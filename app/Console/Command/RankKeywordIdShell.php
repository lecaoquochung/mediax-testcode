 ...
 * @created
 * run: rank_keyword_id 0 100 15 0 10 30 10 0 1,2,3,4
 *-----------------------------------------------------------------------------------------------------------*/	
...
class RankKeywordIdShell extends Shell {
	...
	public function main() {
		...
		// param08: nocontract or contract
		$nocontract = 0;
		...
		if(isset($this->args[8])) {
			$keyword_id = explode(',', $this->args[8]);
		}
		...
		$this -> out(exec('hostname') .' ' .$server_ip);
